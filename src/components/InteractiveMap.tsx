      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 bg-white dark:bg-slate-800 rounded-[3rem] shadow-2xl border border-gray-100 dark:border-slate-700 overflow-hidden relative group h-[400px] sm:h-[500px] lg:h-[600px]">
          ...
          <div className="absolute top-6 left-6 z-10 flex flex-col gap-2">
            <button onClick={() => zoom(1.2)} aria-label="放大地圖" className="p-3 bg-white/90 dark:bg-slate-700/90 backdrop-blur rounded-2xl shadow-xl hover:text-primary transition-all active:scale-95"><ZoomIn className="w-5 h-5" /></button>
            <button onClick={() => zoom(0.8)} aria-label="縮小地圖" className="p-3 bg-white/90 dark:bg-slate-700/90 backdrop-blur rounded-2xl shadow-xl hover:text-primary transition-all active:scale-95"><ZoomOut className="w-5 h-5" /></button>
            <button onClick={() => setScale(1)} aria-label="重設地圖縮放" className="p-3 bg-white/90 dark:bg-slate-700/90 backdrop-blur rounded-2xl shadow-xl hover:text-primary transition-all active:scale-95"><RotateCcw className="w-5 h-5" /></button>
          </div>
            ...
            {selectedSpot ? (
              <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <button onClick={() => setSelectedSpot(null)} aria-label="關閉景點資訊" className="p-2 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-full">
              ...
              <div className="h-full flex flex-col items-center justify-center text-center py-20">
                ...
                <p className="text-2xl font-bold text-gray-400 mb-2">選取景點標籤</p>
