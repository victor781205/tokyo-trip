...
export function Tips() {
  ...
  return (
    <section id="tips" className="py-6 md:py-12 max-w-6xl mx-auto animate-in fade-in duration-700 scroll-mt-28">
        ...
        {tips.map((tip, i) => (
          <article key={i} className="bg-white dark:bg-slate-800 p-6 rounded-[2rem] shadow-xl border border-gray-100 dark:border-slate-700 hover:shadow-2xl transition-all duration-300 group">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="font-black text-xl text-gray-900 dark:text-white uppercase tracking-tighter">{tip.title}</h3>
            </div>
      ...
      <div className="mt-16 bg-gray-900 text-white p-8 md:p-12 rounded-[3rem] relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left space-y-2">
            <h3 className="text-3xl font-black italic flex items-center justify-center md:justify-start gap-3">
