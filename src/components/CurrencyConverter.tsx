      ...
      <section id="currency" className="py-20 px-6 max-w-4xl mx-auto">
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[3rem] p-8 md:p-12 shadow-2xl text-white">
          <div className="flex items-center gap-4 mb-10">
            <div className="bg-white/10 p-3 rounded-2xl w-14 h-14 animate-pulse" />
            <div>
              <div className="h-8 w-44 bg-white/20 rounded-xl animate-pulse mb-2" />
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              <div>
                <div className="h-4 w-20 bg-white/20 rounded-lg animate-pulse mb-2" />
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-[2rem] p-8 border border-white/10 h-48 animate-pulse" />
          </div>
        </div>
      </section>
    );
