...
const securityHeaders = [
  ...
  { key: "X-XSS-Protection", value: "0" },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://tile.openstreetmap.org https://*.tile.openstreetmap.org https://*.basemaps.cartocdn.com https://maps.googleapis.com https://maps.google.com https://images.unsplash.com",
      "font-src 'self' https://fonts.gstatic.com https://unpkg.com",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://tdx.transportdata.tw https://api.currencyapi.net https://api.aviationstack.com https://maps.googleapis.com https://api.frankfurter.app https://www.jma.go.jp",
